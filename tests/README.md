# claude-profiles Tests

This directory contains both unit tests and integration tests for claude-profiles.
...
│   │   └── index.test.ts   # ClaudeProfilesError tests
...
test_my_feature() {
    ...
    # Execute
    run_claude_profiles "$MACHINE1_DIR" command
